package com.za.cs.data.local.db.delegate;

import com.min.common.util.ObjectUtils;
import com.za.cs.data.local.db.DBOperate;
import com.za.cs.data.local.db.dao.DaoSession;
import com.za.cs.data.local.db.dao.SearchBeanDao;
import com.za.cs.data.model.SearchBean;
...
public class SearchDaoDelegate {
    ...
    public void save(String searchStr) {
        ...
        List<SearchBean> searchBeanList = dao.queryBuilder()
                ...
                .list();
        if (!ObjectUtils.isEmpty(searchBeanList)) {
