...
public class StateLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            this.loadingLayoutId = typedArray.getResourceId(R.styleable.StateLayout_loading_layout, R.layout.layout_load_ing);
            this.emptyLayoutId = typedArray.getResourceId(R.styleable.StateLayout_empty_layout, R.layout.layout_load_empty);
            this.errorLayoutId = typedArray.getResourceId(R.styleable.StateLayout_error_layout, R.layout.layout_load_error);
