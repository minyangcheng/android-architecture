 ...
 *     <com.min.common.widget.MsgView
 *         android:layout_width="wrap_content"
 *         android:layout_height="15dp"
 *         android:textColor="#ffffff"
 *         android:gravity="center"
 *         app:mv_backgroundColor="#FF6347"
 *         app:mv_strokeWidth="1px"
 *         app:mv_strokeColor="#B3EE3A"
 *         app:mv_isRadiusHalfHeight="true"
 *         app:mv_isWidthHeightEqual="true"
    ...
    public void showMessage(int num){
        ...
        if(num<=0){
            ...
            if (num > 0 && num < 10) {//圆
                ...
                setPadding(sp2px(6), 0, sp2px(6), 0);
                setText(num + "");
            } else {//数字超过两位,显示99+
                lp.width = ViewGroup.LayoutParams.WRAP_CONTENT;
                setPadding(sp2px(6), 0, sp2px(6), 0);
